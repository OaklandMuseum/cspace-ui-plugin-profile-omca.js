  ...
  return (
    <Field name="document">
      <Panel name="info" collapsible>
        ...
        <Row>
          <Field name="legacyArgusNotes" subpath="ns2:organizations_omca" />

          <Col>
            <Field name="legacyParents" subpath="ns2:organizations_omca" />
            <Field name="legacySeeAlso" subpath="ns2:organizations_omca" />
          </Col>
        </Row>
      </Panel>
